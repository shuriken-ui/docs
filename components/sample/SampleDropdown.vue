        ...
        <div>
          <PlaygroundSampleRow label="Button" label-align="center">
            <div class="flex w-full justify-start gap-8">
              <BaseDropdown variant="button" label="Dropdown" orientation="start" size="md" fixed>
              ...
              <BaseDropdown variant="button" label="Dropdown" button-color="primary" orientation="start" size="md" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Projects" text="View your projects" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Team" text="Manage your team" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Settings" text="Set your preferences" color="default" rounded="sm" />
              </BaseDropdown>
              <BaseDropdown variant="button" label="Dropdown" orientation="end" size="lg" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Projects" text="View your projects" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Team" text="Manage your team" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Settings" text="Set your preferences" color="default" rounded="sm" />
        ...
        <div class="space-y-4">
          <PlaygroundSampleRow label="Context" label-align="center">
            <div class="flex w-full justify-start gap-8 py-3">
              <BaseDropdown variant="context" label="Dropdown" orientation="start" size="md" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Projects" text="View your projects" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Team" text="Manage your team" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Settings" text="Set your preferences" color="default" rounded="sm" />
              </BaseDropdown>
              <BaseDropdown variant="context" label="Dropdown" orientation="end" size="md" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Projects" text="View your projects" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Team" text="Manage your team" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Settings" text="Set your preferences" color="default" rounded="sm" />
      ...
      <div v-if="activeValue === 'text'" class="relative pb-4">
        <div class="space-y-4">
          <PlaygroundSampleRow label="Text" label-align="center">
            <div class="flex w-full justify-start gap-8">
              <BaseDropdown variant="text" label="Dropdown" orientation="start" size="md" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Projects" text="View your projects" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Team" text="Manage your team" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Settings" text="Set your preferences" color="default" rounded="sm" />
              </BaseDropdown>
              <BaseDropdown variant="text" label="Dropdown" orientation="end" size="md" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Projects" text="View your projects" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Team" text="Manage your team" color="default" rounded="sm" />
                <BaseDropdownItem to="#" title="Settings" text="Set your preferences" color="default" rounded="sm" />
      ...
      <div v-if="activeValue === 'icons'" class="relative pb-4">
        <div class="space-y-4">
          <PlaygroundSampleRow label="Icons" label-align="center">
            <div class="flex w-full justify-start gap-8">
              <BaseDropdown variant="button" label="Dropdown" orientation="start" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm">
                  <template #start>
              ...
              <BaseDropdown variant="button" label="Dropdown" orientation="end" fixed>
                <BaseDropdownItem to="#" title="Profile" text="View your profile" color="default" rounded="sm">
                  <template #start>
                    <Icon name="ph:user-duotone" class="me-2 block h-5 w-5" />
                  </template>
