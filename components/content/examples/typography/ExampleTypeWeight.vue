<template>
  <div class="py-6">
    <BaseCard contrast="default-contrast" rounded="md" class="p-6 space-y-1">
      ...
      <BaseHeading as="h5" size="md" weight="semibold">Semibold text</BaseHeading>
      <BaseHeading as="h5" size="md" weight="bold">Bold text</BaseHeading>
      <BaseHeading as="h5" size="md" weight="extrabold">Extrabold text</BaseHeading>
    </BaseCard>
  </div>
</template>