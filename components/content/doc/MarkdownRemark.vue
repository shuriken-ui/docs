...
import light from '~/utils/shiki/theme/light'
import dark from '~/utils/shiki/theme/dark'
...
<template>
  ...
  <BaseProse
    ...
    :class="[
      proseSize,
      'markdown',
      props.minimal ? 'minimal' : 'nui-focus',
...
.minimal :deep(.shiki) {
  @apply !py-0 !px-2 !m-0 whitespace-normal [&>code>.line>*]:!text-muted-700 dark:[&>code>.line>*]:!text-muted-100 !bg-muted-100 dark:!bg-muted-900 [&>code>.line]:!bg-muted-100 dark:[&>code>.line]:!bg-muted-900 [&>code>.line>*]:!bg-muted-100 dark:[&>code>.line>*]:!bg-muted-900;
}
