...
<template>
  <div class="pb-20">
    ...
    <div>
      <a href="#" class="tracking-wide text-sm text-muted-400 hover:text-muted-900 dark:hover:text-muted-100 hover:underline underline-offset-4">Edit this page on Github</a>
    </div>
  </div>
</template>
