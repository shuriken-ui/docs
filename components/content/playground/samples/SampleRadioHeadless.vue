      ...
      <PlaygroundSampleRow label="Example" label-align="start">
        <div class="grid gap-4 sm:grid-cols-4">
          <BaseRadioHeadless v-model="value" name="radio_custom" value="value_1">
            <BaseCard :rounded="rounded as 'none' | 'sm' | 'md' | 'lg'" class="peer-checked:!border-success-500 peer-checked:!bg-success-500/10 relative border-2 p-5 peer-checked:[&_.child]:!opacity-100">
