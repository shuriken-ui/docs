...
<template>
  <header
    class="fixed start-0 top-0 z-40 w-full border-b transition-all duration-300"
    :class="[
  ...
  >
    <!-- Black banner to v4 beta with link -->
    <div class="flex h-10 items-center gap-3 bg-muted-950 px-4 dark:bg-black md:px-6">
      <div class="mx-auto flex w-full max-w-7xl items-center justify-between gap-2">
        <div class="flex h-full items-center gap-2">
          <Icon name="game-icons:whirlpool-shuriken" class="size-6 text-white" />
          <BaseText
            size="xs"
            weight="medium"
            class="text-muted-100"
          >
            Shuriken UI v4 Beta is here! <span class="hidden md:inline">Check out the new features and improvements.</span>
          </BaseText>
        </div>
        <BaseLink
          to="https://v4.shurikenui.com"
          class="inline-flex items-center justify-center rounded-full border border-transparent text-xs font-medium text-muted-100 transition-all duration-200 hover:bg-muted-900 hover:text-muted-100 dark:text-muted-400 dark:hover:text-muted-100"
        >
          Try it out
        </BaseLink>
      </div>
