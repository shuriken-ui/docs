...
::component-header{framework="tailwind" category="components" fileName="listbox/index.ts" storybook="shuriken-ui-form-listbox"}
::

::code-group{expandable}

```html [demo-listbox-base.html]
<div class="nui-listbox nui-listbox-default nui-listbox-md nui-listbox-rounded max-w-xs min-h-[280px]">
