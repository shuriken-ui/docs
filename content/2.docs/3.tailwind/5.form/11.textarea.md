...
::component-header{framework="tailwind" category="components" fileName="textarea/index.ts" storybook="shuriken-ui-form-textarea"}
::

::code-group{expandable}

```html [demo-textarea-base.html]
<div class="nui-textarea-wrapper nui-textarea-default nui-textarea-md nui-textarea-rounded nui-textarea-no-resize">
