...
::component-header{framework="react" category="form" fileName="BaseTreeSelect.tsx" }
::

::code-group{expandable}

```jsx [DemoTreeSelectBase.tsx]
...
```jsx [DemoTreeSelectItemIcon.tsx]
...
```jsx [DemoTreeSelectItemMedia.tsx]
import { BaseTreeSelect, BaseTreeSelectItem } from "@shuriken-ui/react";
