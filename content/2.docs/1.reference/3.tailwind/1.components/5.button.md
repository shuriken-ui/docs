...
`<Button />` · A classic and versatile interaction.

::component-header{framework="tailwind" category="src/plugins/components" fileName="button/index.ts" storybook="shuriken-ui-base-button"}
::

::code-group{expandable}

```html [demo-button-base.html]
