...
::component-header{framework="tailwind" category="src/plugins/components" fileName="prose/index.ts" storybook="shuriken-ui-base-prose"}
::

::code-group{expandable}

```html [demo-prose-base.html]
<div class="max-w-3xl mx-auto py-6">
  <div class="nui-prose nui-prose-rounded-md prose-md">
