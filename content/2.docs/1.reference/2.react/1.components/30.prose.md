...
::component-header{framework="react" category="ui/src/components/base" fileName="BaseProse.tsx" }
::

::code-group{expandable}

```tsx [DemoProseBase.tsx]
  ...
  return (
    <div>
      <div className="max-w-3xl mx-auto py-6">
        <BaseProse rounded="md" className="prose-md">
          ...
          <p>
            It adds a new
            <code>prose</code>
            className that you can slap on any block of vanilla HTML content and turn it into a beautiful, well-formatted document:
          </p>
