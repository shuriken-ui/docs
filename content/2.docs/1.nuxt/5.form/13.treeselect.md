...
```js [DemoTreeSelectItemMedia.vue]
<template>
  <BaseTreeSelect :children="tree" treeline>
    <template #item-label="{ level, child, toggle }">
      <BaseTreeSelectItem
